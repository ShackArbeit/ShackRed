...
// onMounted(()=>{
//     textCardStore.toggleTextInput(props.textCardId,true)
// })
watch([textTitle,textContent],([newTextTitle,newTextContent])=>{
      textCardStore.updateTextCard(props.textCardId,newTextTitle,newTextContent)
})


// 使用從 AddAndRemoveLinkCard.js 中引入的 useTextCardStore 函式
const textCardStore=useTextCardStore()
function deleteTextCard(textCardId){
     textCardStore.deleteTextCard(textCardId)
     console.log('已經刪除卡片了')
}
function toggleTextAreaVisibility(textCardId){
    textCardStore.toggleTextInput(textCardId)
}
</script>
...
<div class="container">
 ...
 <div class="rightPart">
    <div class="inputContainer">
        <!-- 文字標題 -->
        <input class="inputStyle" placeholder="文字標題"  type="text"
          v-model="textTitle"
        >
        <!-- 文字 -->
        <input class="inputStyle" placeholder="文字內容"  type="text" 
          v-model="textContent"
        >
    </div>
    <!-- Icon 容器部分 -->
    <div class="iconContainer">
        <div class="deleteContainer" @click="deleteTextCard(props.textCardId)">
        ...
        <div class="panel panel-default">
                  <div class="panel-body">
                    <label class="switch2" >
                      <input type="checkbox" v-model="isChecked" @change="toggleTextAreaVisibility(props.textCardId)"
                      />
